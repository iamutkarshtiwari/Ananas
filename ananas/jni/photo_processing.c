...
Java_iamutkarshtiwari_github_io_ananas_editimage_fliter_PhotoProcessing_freeBeautifyMatrix(JNIEnv *env, jobject obj) {
    freeMatrix();
}

JNIEXPORT void JNICALL
Java_iamutkarshtiwari_github_io_ananas_editimage_fliter_PhotoProcessing_handleSmoothAndWhiteSkin(JNIEnv *env, jobject obj, jobject bitmap,
...
JNIEXPORT void JNICALL
Java_iamutkarshtiwari_github_io_ananas_editimage_fliter_PhotoProcessing_handleSmooth(JNIEnv *env, jobject obj, jobject bitmap,
                                         jfloat smoothValue) {
    AndroidBitmapInfo info;
    void *pixels;
    int ret;
...
JNIEXPORT void JNICALL
Java_iamutkarshtiwari_github_io_ananas_editimage_fliter_PhotoProcessing_handleWhiteSkin(JNIEnv *env, jobject obj, jobject bitmap,
                                            jfloat whiteValue) {
    AndroidBitmapInfo info;
    void *pixels;
    int ret;
